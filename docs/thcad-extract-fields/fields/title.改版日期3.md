...
- **字段 ID**：`title.改版日期3`
- **JSON 路径**：`semantic-objects.json / title_blocks[].fields.改版日期3`
...
PCCAD 标题栏变更栏格子 `改版日期3`（改版标记/处数/分区/更改文件号/签名/日期，三栏）。天河 PCCAD 把标题栏、明细表、序号做成专业对象并双向关联（官网功能说明与命令表：PC_BTLEDIT / PC_MXB / PC_XH，https://www.thcad.net/pccad 、https://www.thcad.net/5485.html）。
