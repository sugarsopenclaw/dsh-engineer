...
- **字段 ID**：`entity.custom.properties.Annotative`
- **JSON 路径**：`entities.jsonl / custom.properties.Annotative`
...
TH_* 反射属性 `Annotative`。公开文档没有天河专业对象自己的字段表，这些是基类 Entity/Dimension 属性。
