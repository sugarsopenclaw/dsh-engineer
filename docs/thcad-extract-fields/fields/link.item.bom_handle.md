...
- **字段 ID**：`link.item.bom_handle`
- **JSON 路径**：`xuhao-bom-links.json / links[].bom_handle`
...
- 计数：{"seen": 24}
- 实测例子：
  - `5TBC.384.A110050.2_1 link:seq=14: 45F7`
  - `5TBC.384.A110050.2_1 link:seq=8: 45BB`
  - `5TBC.384.A110050.2_1 link:seq=17: 4615`
  - `5TBC.384.A110050.2_1 link:seq=20: 4633`
  - `5TBC.384.A110050.2_1 link:seq=12: 45E3`
  - `5TBC.384.A110050.2_1 link:seq=18: 461F`
