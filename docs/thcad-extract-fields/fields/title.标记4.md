...
- **字段 ID**：`title.标记4`
- **JSON 路径**：`semantic-objects.json / title_blocks[].fields.标记4`
...
PCCAD 标题栏属性 tag `标记4`，企业可定制的附加标记格。天河 PCCAD 把标题栏、明细表、序号做成专业对象并双向关联（官网功能说明与命令表：PC_BTLEDIT / PC_MXB / PC_XH，https://www.thcad.net/pccad 、https://www.thcad.net/5485.html）。
