...
- **字段 ID**：`link.item.bom_material`
- **JSON 路径**：`xuhao-bom-links.json / links[].bom_material`
...
- 计数：{"seen": 24, "empty": 24}
- 空值例子（图上没填或空串，不是漏抽）：
  - `5TBC.384.A110050.2_1 link:seq=14: `
  - `5TBC.384.A110050.2_1 link:seq=8: `
  - `5TBC.384.A110050.2_1 link:seq=17: `
