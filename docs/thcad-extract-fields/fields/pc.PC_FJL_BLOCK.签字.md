...
- **字段 ID**：`pc.PC_FJL_BLOCK.签字`
- **JSON 路径**：`semantic-objects.json / other_pc_blocks[PC_FJL_BLOCK].fields.签字`
...
PCCAD 附加栏 `PC_FJL_BLOCK` 属性 `签字`，命令 PC_FJLEDIT。
