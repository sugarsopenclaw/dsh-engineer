...
- **字段 ID**：`link.item.recorder_handle`
- **JSON 路径**：`xuhao-bom-links.json / links[].recorder_handle`
...
- 计数：{"seen": 24}
- 实测例子：
  - `5TBC.384.A110050.2_1 link:seq=14: 55F4`
  - `5TBC.384.A110050.2_1 link:seq=8: 5609`
  - `5TBC.384.A110050.2_1 link:seq=17: 5608`
  - `5TBC.384.A110050.2_1 link:seq=20: 5607`
  - `5TBC.384.A110050.2_1 link:seq=12: 5606`
  - `5TBC.384.A110050.2_1 link:seq=18: 5605`

## CAD 含义

关联记录 TH_BOMItem2XuhaoAssoiateRecoder handle。
