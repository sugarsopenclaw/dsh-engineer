...
- **字段 ID**：`pc.PC_FJL_BLOCK.底图总号`
- **JSON 路径**：`semantic-objects.json / other_pc_blocks[PC_FJL_BLOCK].fields.底图总号`
...
PCCAD 附加栏 `PC_FJL_BLOCK` 属性 `底图总号`，命令 PC_FJLEDIT。
