...
- **字段 ID**：`link.item.xuhao_handle`
- **JSON 路径**：`xuhao-bom-links.json / links[].xuhao_handle`
...
- 计数：{"seen": 24}
- 实测例子：
  - `5TBC.384.A110050.2_1 link:seq=14: 28F6`
  - `5TBC.384.A110050.2_1 link:seq=8: 203B`
  - `5TBC.384.A110050.2_1 link:seq=17: 29FE`
  - `5TBC.384.A110050.2_1 link:seq=20: 2D83`
  - `5TBC.384.A110050.2_1 link:seq=12: 268D`
  - `5TBC.384.A110050.2_1 link:seq=18: 2ADE`

## CAD 含义

气泡 TH_XuHaoEntity handle，如 `1F6A`。
