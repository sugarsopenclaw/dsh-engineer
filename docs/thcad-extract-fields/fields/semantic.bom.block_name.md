...
- **字段 ID**：`semantic.bom.block_name`
- **JSON 路径**：`semantic-objects.json / bom[].block_name`
...
- 计数：{"seen": 208}
- 实测例子：
  - `5TBC.384.A110050.1_1 bom:4CCA4: PC_MXB_BLOCK`
  - `5TBC.384.A110050.1_1 bom:4CCAE: PC_MXB_BLOCK`
  - `5TBC.384.A110050.1_1 bom:4CCB8: PC_MXB_BLOCK`
  - `5TBC.384.A110050.1_1 bom:4CCC2: PC_MXB_BLOCK`
  - `5TBC.384.A110050.1_1 bom:4CCCC: PC_MXB_BLOCK`
  - `5TBC.384.A110050.1_1 bom:4CCD6: PC_MXB_BLOCK`
