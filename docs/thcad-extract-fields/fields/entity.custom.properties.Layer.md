...
- **字段 ID**：`entity.custom.properties.Layer`
- **JSON 路径**：`entities.jsonl / custom.properties.Layer`
...
- 实测例子：
  ...
  - `5TBC.384.A110050.1_1 h=6A3C TH_XuHaoEntity: 7标注层`
  - `5TBC.384.A110050.1_1 h=6A56 TH_XuHaoEntity: 7标注层`
  - `5TBC.384.A110050.1_1 h=6A5A TH_XuHaoEntity: 7标注层`

## CAD 含义

TH_* 反射属性 `Layer`。公开文档没有天河专业对象自己的字段表，这些是基类 Entity/Dimension 属性。
