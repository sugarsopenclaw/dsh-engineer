...
- **字段 ID**：`entity.custom.properties.StartPoint`
- **JSON 路径**：`entities.jsonl / custom.properties.StartPoint`
...
TH_* 反射属性 `StartPoint`。公开文档没有天河专业对象自己的字段表，这些是基类 Entity/Dimension 属性。
