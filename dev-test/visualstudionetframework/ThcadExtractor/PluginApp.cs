...
[assembly: ExtensionApplication(typeof(Shb.Thcad.Extractor.PluginApp))]
[assembly: CommandClass(typeof(Shb.Thcad.Extractor.Commands))]

namespace Shb.Thcad.Extractor
{
    public sealed class PluginApp : IExtensionApplication
    {
        const string Breadcrumb = @"D:\dev\dsh-engineer\dev-test\visualstudionetframework\out-thcad\_plugin-loaded.txt";
        ...
        public void Initialize()
        {
            ...
            try
            {
                Commands.WriteMessage("\nShb.Thcad.Extractor loaded. Command: SHBEXTRACT\n");
            }
            catch
            {
